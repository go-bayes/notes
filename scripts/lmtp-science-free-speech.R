...
mean_exposure <- mean(dt_19$trust_science_high_confidence_scientific_community,
                      na.rm = TRUE)
...
min_score <- min(dt_19$trust_science_high_confidence_scientific_community, na.rm = TRUE)
min_score

max_score <- max(dt_19$trust_science_high_confidence_scientific_community, na.rm = TRUE)
max_score

sd_exposure <- sd(dt_19$trust_science_high_confidence_scientific_community,
                  na.rm = TRUE)
sd_exposure
...
max_score<- df_clean$t1_trust_science_high_confidence_scientific_community
f <- function(data, trt) {
  ifelse(data[[trt]] <= max_score - 1, data[[trt]] + 1,  data[[trt]])
}
...
t2_trust_science_high_confidence_scientific_community_z_trt_A_1 <- lmtp_tmle(
  data = df_clean,
  trt = A_1,
  baseline = names_base,
...
here_save(t2_trust_science_high_confidence_scientific_community_z_trt_A_1, 
          "t2_trust_science_high_confidence_scientific_community_z_trt_A_1")
