...
ml_3 <- lm(t2_trust_science_our_society_places_too_much_emphasis_reversed_z ~ bs(t1_modesty_z) *
             (t0_eth_cat + t0_male_z + t0_age_z + t0_nz_dep2018_z + t0_nzsei13_z + 
                t0_born_nz_z + t0_household_inc_log_z + t0_partner_z + t0_parent_z + 
                t0_political_conservative_z + t0_urban_z + t0_agreeableness_z + 
                t0_conscientiousness_z + t0_extraversion_z + t0_honesty_humility_z + 
...
plot( ggeffects::ggeffect(ml_3, terms = c("t1_modesty_z")))



#  Conditional
ml_4 <- lm(t2_pol_wing_z ~ bs(t1_modesty_z) *
             (t0_eth_cat + t0_male_z + t0_age_z + t0_nz_dep2018_z + t0_nzsei13_z + 
                t0_born_nz_z + t0_household_inc_log_z + t0_partner_z + t0_parent_z + 
                t0_political_conservative_z + t0_urban_z + t0_agreeableness_z + 
                t0_conscientiousness_z + t0_extraversion_z + t0_honesty_humility_z + 
...
plot( ggeffects::ggeffect(ml_4, terms = c("t1_modesty_z")))
...
test_sdr
here_save(test_sdr, "test_sdr")
print(paste("Time taken: ", round(timing_info_sdr['elapsed'], 2), " seconds"))
...
t2_free_speech_z_modesty_up_one <- here_read( "t2_free_speech_z_modesty_up_one")



## TEST -- OVERSTATES EFFECT
# ipw_t2_free_speech_z_modesty_up_one <- lmtp_ipw(
#   data = df_clean,
#   trt = A,
#   baseline = names_base,
#   outcome = "t2_free_speech_z",
...
# )
# 
# here_save(ipw_t2_free_speech_z_modesty_up_one, "ipw_t2_free_speech_z_modesty_up_one")
# ipw_t2_free_speech_z_modesty_up_one <- here_read( "ipw_t2_free_speech_z_modesty_up_one")
...
sdr_t2_free_speech_z_modesty_up_one <- lmtp_sdr(
  data = df_clean,
  trt = A,
  baseline = names_base,
  outcome = "t2_free_speech_z",
...
sdr_t2_free_speech_z_modesty_up_one
here_save(sdr_t2_free_speech_z_modesty_up_one, "sdr_t2_free_speech_z_modesty_up_one")
sdr_t2_free_speech_z_modesty_up_one <- here_read( "sdr_t2_free_speech_z_modesty_up_one")
### COMPARE
t2_free_speech_z_modesty_up_one
ipw_t2_free_speech_z_modesty_up_one
sdr_t2_free_speech_z_modesty_up_one
